...
import { BuildingsList } from '@/features/admin/components/BuildingsList'
import { WeatherWidget } from '@/features/admin/components/WeatherWidget'
import NodeTypeCard from '../../../components/NodeTypeCard'
import { useWorkerDashboard } from '../hooks/useWorkerQueries'
...
const NODE_TYPES = [
	{
		...
		image: gangformImg,
		active: true,
		route: '/worker/buildings/:buildingId/gangform-nodes',
	},
	{
		type: 'angle_node',
		...
		image: angleImg,
		active: true,
		route: '/worker/buildings/:buildingId/angle-nodes',
	},
	{
		type: 'door_node',
		...
		image: doorImg,
		active: true,
		route: '/worker/buildings/:buildingId/scaffold-nodes',
	},
]

export default function WorkerBuildingsPage() {
									...
									>
										<div className='flex items-center justify-between w-full '>
											...
											<span className='ml-2 bg-destructive/20 text-destructive text-xs px-1.5 py-0.5 rounded'>
												{building.statistics?.totalGatewaysCounts}
											</span>
										</div>
									</SelectItem>
								))}
