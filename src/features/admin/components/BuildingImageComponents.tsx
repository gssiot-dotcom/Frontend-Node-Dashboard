...
// ─── Usage in CompanyBuildingsPage ────────────────────────────────────────────
//
// Replace your imageModal state + Dialog section with this pattern:
//
...
// }
//
// ── In JSX, replace the two image cards with: ──
//
// <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
//   <BuildingImagePreviewCard
//     images={selectedBuilding.buildingPlanImage || []}
//     fallbackImage={DEFAULT_PLAN_IMAGE}
//     title={t('dashboard.buildingImages.planImage.title')}
//     subtitle={t('dashboard.buildingImages.planImage.subtitle')}
//     badge="Plan"
//     onImageClick={(i) =>
//       openCarousel(
//         selectedBuilding.buildingPlanImage?.length
//           ? selectedBuilding.buildingPlanImage
//           : [DEFAULT_PLAN_IMAGE],
...
//   />
//   <BuildingImagePreviewCard
//     images={selectedBuilding.buildingRealImage || []}
//     fallbackImage={DEFAULT_READY_IMAGE}
//     title={t('dashboard.buildingImages.readyImage.title')}
//     subtitle={t('dashboard.buildingImages.readyImage.subtitle')}
//     badge="Ready"
//     onImageClick={(i) =>
//       openCarousel(
//         selectedBuilding.buildingRealImage?.length
//           ? selectedBuilding.buildingRealImage
//           : [DEFAULT_READY_IMAGE],
...
// </div>
//
// ── And at the bottom, replace the old Dialog with: ──
//
// <ImageCarouselDialog
