...
import {
	useCreateManagerMember,
	useManagerMembers,
	useUpdateManagerMemberStatuses,
} from '../hooks/usemanagerCompany'
...
export function AssignManagerDialog({
	...
	const createCompanyMemberUserMutation = useCreateManagerMember()
	const updateCompanyMemberStatusesMutation = useUpdateManagerMemberStatuses()
								...
								filteredMembers.map(member => (
									...
									>
										<Checkbox
											...
											onCheckedChange={() => handleToggleMember(member._id)}
										/>
